...
static NSInteger kMaximumNumberOfLines = 6;
...
- (BOOL)textView:(UITextView *)textView shouldChangeTextInRange:(NSRange)range replacementText:(NSString *)text {
    NSString *string = self.chatTextView.text;
    
    NSInteger maximumLength = 160;
    if([text canBeConvertedToEncoding:NSASCIIStringEncoding] == NO || [string canBeConvertedToEncoding:NSASCIIStringEncoding] == NO) {
        maximumLength = 70;
    }
